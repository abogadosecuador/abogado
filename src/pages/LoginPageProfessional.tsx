...
const LoginPageProfessional: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Verificar si es el usuario admin hardcoded
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center">
            <div className="mx-auto h-20 w-20 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-full flex items-center justify-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Accede a tu cuenta de Abogados Ecuador
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-700 font-medium mb-2">Credenciales de prueba:</p>
            <div className="text-xs text-blue-600">
              <p>Admin: willyipiales12@gmail.com / willy12</p>
              <p>Demo: demo@usuario.com / demo123</p>
            </div>
          </div>
        </div>
      </div>
...
export default LoginPageProfessional;
