...
const Hero = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-neutral-900 via-brand-dark to-neutral-900 overflow-hidden">
      {/* Overlay pattern */}
        ...
        <div className="pt-12 pb-20 sm:pt-16 sm:pb-24 lg:pt-20 lg:pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-neutral-200 mb-8 max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                <Link
                  to="/contacto"
                  className="bg-accent hover:bg-accent-dark text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors duration-300 shadow-lg inline-flex items-center justify-center"
                >
                  Consulta Gratis
                ...
                <a 
                  ...
                  className="flex-1 bg-success hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all"
                >
                ...
                <Link 
                  to="/calendario" 
                  className="flex-1 bg-white hover:bg-neutral-100 text-brand-dark font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all"
                >
            ...
            <div className="lg:w-full">
              ...
              >
                {featuredServices.map((service, index) => (
                  ...
                  >
                    <Link to={service.link} className="flex flex-col h-full">
                      ...
                      <p className="text-sm text-neutral-200 mb-3">{service.description}</p>
                      <div className="mt-auto pt-3 border-t border-white/10 flex justify-between items-center">
                        <span className="text-xs text-neutral-300">Ver detalles</span>
                        <div className="bg-white/20 rounded-full p-1 group-hover:bg-brand transition-all">
                ...
                <motion.div 
                  className="md:col-span-2 bg-gradient-to-r from-brand to-brand-dark border border-brand rounded-xl p-5"
                  variants={itemVariants}
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div>
                      ...
                      <div className="text-xs text-neutral-200">Años de Experiencia</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-warning">50+</div>
                      <div className="text-xs text-neutral-200">Casos Ganados</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-warning">200+</div>
                      <div className="text-xs text-neutral-200">Clientes Satisfechos</div>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
          ...
          >
            <div className="flex items-center mb-2">
              <span className="bg-danger text-white text-xs font-bold px-2 py-1 rounded">OFERTA ESPECIAL</span>
            ...
            <div className="flex justify-center space-x-4 mb-3">
              <div className="flex flex-col items-center">
                <div className="bg-brand text-white rounded-md px-3 py-2 font-mono text-xl font-bold">
                  {countdown.days}
                </div>
                <span className="text-xs text-neutral-300 mt-1">Días</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-brand text-white rounded-md px-3 py-2 font-mono text-xl font-bold">
                  {countdown.hours}
                </div>
                <span className="text-xs text-neutral-300 mt-1">Horas</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-brand text-white rounded-md px-3 py-2 font-mono text-xl font-bold">
                  {countdown.minutes}
                </div>
                <span className="text-xs text-neutral-300 mt-1">Min</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-brand text-white rounded-md px-3 py-2 font-mono text-xl font-bold">
                  {countdown.seconds}
                </div>
                <span className="text-xs text-neutral-300 mt-1">Seg</span>
              </div>
            </div>
            
            <Link 
              to="/contacto" 
              className="w-full bg-gradient-to-r from-accent to-accent-light hover:from-accent-light hover:to-accent text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-105"
            >
