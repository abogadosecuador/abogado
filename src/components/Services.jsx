...
const legalServices = [
  {
    ...
    price: 'Desde $500',
    icon: <FaGavel className="text-danger text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $500',
    icon: <FaBalanceScale className="text-brand text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $600',
    icon: <FaFileContract className="text-warning text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $400',
    icon: <FaCarCrash className="text-success text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $550',
    icon: <FaBuilding className="text-accent text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $450',
    icon: <FaShip className="text-brand-light text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $450',
    icon: <FaUserTie className="text-warning text-3xl mb-4" />,
    features: [
  ...
  },
  {
    ...
    price: 'Desde $350',
    icon: <FaMoneyBillWave className="text-success text-3xl mb-4" />,
    features: [
      'Juicios ejecutivos',
      ...
      <div className="container-custom">
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-neutral-900 mb-8 flex items-center">
            <FaGavel className="mr-2 text-brand" /> Servicios de Patrocinio Legal
          </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {legalServices.map((service, index) => (
              <motion.div
                key={service.id}
                className="bg-white rounded-xl shadow-md overflow-hidden border border-neutral-100 hover:border-brand/30 transition-all duration-300"
              ...
              >
                <div className="p-6">
                  ...
                  <h4 className="text-xl font-bold text-neutral-900 mb-2 text-center">
                    {service.title}
                  </h4>
                  <p className="text-neutral-600 mb-4 text-center">{service.description}</p>
                  <div className="text-xl font-bold text-brand mb-4 text-center">
                    {service.price}
                  </div>
                  ...
                  <ul className="space-y-2 mb-6">
                    {service.features.map((feature, idx) => (
                      ...
                      >
                        <svg
                          className="w-4 h-4 text-accent mr-2 mt-1 flex-shrink-0"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                  ...
                  <Link to={`/servicios/${service.id}`}>
                    <motion.button
                      className="w-full bg-brand text-white hover:bg-brand-dark px-4 py-2 rounded-lg font-semibold flex items-center justify-center space-x-2"
        ...
        <div>
          <h3 className="text-2xl font-bold text-neutral-900 mb-8 flex items-center">
            <FaHandshake className="mr-2 text-accent" /> Planes de Suscripción
          </h3>
          <p className="text-lg text-neutral-600 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <motion.div
                key={pkg.name}
                className={`${pkg.color} rounded-2xl p-8 shadow-lg transform transition-all duration-300 hover:scale-105 ${pkg.popular ? 'border-2 border-accent relative' : 'border border-neutral-100'}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                {pkg.popular && (
                  <div className="absolute top-0 right-0 bg-accent text-white px-4 py-1 rounded-bl-lg rounded-tr-lg text-sm font-bold">
                    Más Popular
                  </div>
                )}
                <div className="text-center mb-8">
                  ...
                  <div className="text-4xl font-bold text-brand mb-4">
                    ${pkg.price}
                    <span className="text-base font-normal text-neutral-600">/mes</span>
                  </div>
                </div>
                ...
                <ul className="space-y-4 mb-8">
                  {pkg.features.map((feature) => (
                    ...
                    >
                      <svg
                        className="w-5 h-5 text-brand mr-3 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                ...
                <motion.button
                  className="w-full bg-brand text-white hover:bg-brand-dark px-4 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2"
